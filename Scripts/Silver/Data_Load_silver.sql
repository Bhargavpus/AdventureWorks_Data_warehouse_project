...
BEGIN
    ...
    BEGIN TRY 
        ...
        SELECT
        *,
        ROW_NUMBER() OVER(PARTITION BY cst_id ORDER BY cst_create_date) duplicate_test
        FROM bronze.crm_cust_info
        WHERE cst_id iS NOT NULL
        )t WHERE duplicate_test = 1
